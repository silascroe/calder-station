...
- Four authored civic chains now distribute consequential commitments across existing relationships and underused places. Follow-ups carry parent IDs; delays retry; failures end a cycle until cooldown. Relationship tension and diminishing gains make outcomes non-monotonic. With full-day resident scheduling, Day 90 reaches 15 of 27 ties, leaves one relationship weaker, and saturates none; by Day 365 it reaches 18 ties but repairs every net loss. That recovery bias remains an open simulation weakness.
...
3. Investigate the remaining recovery bias and nine relationship edges that still see no encounter by Day 365 before adding another broad mechanic.
